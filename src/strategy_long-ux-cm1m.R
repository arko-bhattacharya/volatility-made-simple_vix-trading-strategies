## This function implements a strategy where one is long invested all
## the time in a one month constant maturity vix index future.
##
...
strategy <- function(data)
  {
    buy_date <- data$date[2:norw(data)]
    sell_date <- data$date[1:(norw(data) - 1)]

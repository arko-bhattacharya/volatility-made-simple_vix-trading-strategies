...
## the aaumption is we keep on re-investing a constant fixed amount
...
## range/duration (sim_range) is assumed to be provided in days.
...
# This function tells us the average number of trades indicated by the
# strategy.

...
## 'Chasing the Volatility Risk Premium (by 'Double-Digit Numerics').
##
...
## 5-day average of the [VIX index – (10-day annualized standard
## deviation of SPY)].
## Short vol (long XIV) when the above expression's value is greater
## than 0 otherwise long vol (long VXX)
##
...
strategy <- function(data)
  {
                                        # 10 day look back annualised standard deviation
                                        # of SPY
